...
based on https://www.youtube.com/watch?v=yyirhTQImVQ&index=24&list=PLQVvvaa0QuDd0flgGphKCej-9jp-QdzZ3
            ...
            for file in each_file:
                ...
                try:
                    ...
                    for each_data in gather:
                        try:
                            value = html.xpath("//tr/td[contains(text(), '" + each_data + "')]/../td[last()]//text()")
