...
Scikit Learn Machine Learning Tutorial for investing with Python p. 18
based on https://www.youtube.com/watch?v=l68b0d92AHQ&list=PLQVvvaa0QuDd0flgGphKCej-9jp-QdzZ3&index=18
...
def Key_Stats(gather=["Total Debt/Equity",
    ...
    stock_df = pd.DataFrame.from_csv('/home/ubuntu/workspace/project/learning/python3-scikit-machinelearning-tutorial/src/stock_prices.csv')
